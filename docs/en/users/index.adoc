...
NOTE: **OpenStack with NovaLXD** is a special case where it is
required for you to install the openstack package. Simply running `sudo
apt install openstack` prior to running conjure-up will setup the
